        ...
        <div class="panel-body">
            <form method="post" action="<?php echo $action; ?>">
                ...
                <div class="row" style="margin-top:5px;">
                    ...
                    <div class="col-md-10">
                        <input type="password" <?php if(isset($record->password)): ?> placeholder="Nếu không đổi password thì không nhập" <?php else: ?> required <?php endif; ?> name="password" class="form-control">
                    </div>
                </div>
                <!-- rows: Submit -->
                <div class="row" style="margin-top:5px;">
