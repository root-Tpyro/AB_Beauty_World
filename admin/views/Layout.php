        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="index.php?controller=trans">
                            <i class="fa fa-th"></i> <span>Quản lý giao dịch QR
                    </li>
                    <li>
                        <a href="index.php?controller=comments">
                    ...
                    <li>
                        <a href="index.php?controller=chat">
                            <i class="fa fa-comments"></i> <span>Chat trực tuyến</span>
                        </a>
                    </li>
                    <li>
